...
Out here in deep space, many things can go wrong. Fortunately, many of those things have indicator lights _(Which indicator lights indicate when the indicator lights have failed?)_. Unfortunately, one of those lights is lit: the oxygen system for part of the ship has failed!
...
The Elves' care package included an [Intcode](Day09.md) program (your puzzle input) that you can use to remotely control the repair droid. By running that program, you can direct the repair droid to the oxygen system and fix the problem.
