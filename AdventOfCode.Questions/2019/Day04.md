...
You arrive at the Venus fuel depot only to discover it's protected by a password. The Elves had written the password on a sticky note, but someone threw it out _(Look on the bright side - isn't it more secure if nobody knows the password?)_.
