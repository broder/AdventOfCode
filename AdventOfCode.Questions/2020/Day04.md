...
You can continue to ignore the `cid` field, but each other field has strict rules _(GLORY TO ARSTOTZKA)_ about what values are valid for automatic validation:
