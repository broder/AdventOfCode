...
Little Jane Marie just got her very first computer for Christmas from some unknown benefactor _(Definitely not Wintermute.)_. It comes with instructions and an example program, but the computer itself seems to be malfunctioning. She's curious what the program does, and would like you to help her run it.
