...
Due to what you can only assume is a mistranslation (you're not exactly fluent in Crab _(If I were going for a programming language pun here, I'd say you were a little... RUSTy.)_), you are quite surprised when the crab starts arranging _many_ cups in a circle on your raft - _one million_ (`1000000`) in total.
