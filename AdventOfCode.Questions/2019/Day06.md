...
Except for the universal Center of Mass (`COM`), every object in space is in orbit around exactly one other object _(What do you mean, Kerbal Space Program doesn't have accurate orbital physics?)_. An [orbit](https://en.wikipedia.org/wiki/Orbit) looks roughly like this:
