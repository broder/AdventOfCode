...
You narrow the problem down to a strange _infinite loop_ in the boot code _(A trendy new line of encrypted footwear?)_ (your puzzle input) of the device. You should be able to fix it, but first you need to be able to run the code in isolation.
