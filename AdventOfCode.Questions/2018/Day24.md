...
The _immune system_ and the _infection_ each have an army _(On second thought, it's pretty similar to regular reindeer immune systems.)_ made up of several _groups_; each _group_ consists of one or more identical _units_. The armies repeatedly _fight_ until only one army has units remaining.
