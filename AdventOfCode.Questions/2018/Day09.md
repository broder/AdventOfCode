...
You talk to the Elves while you wait for your navigation system to initialize _(Do you have any idea how long it takes to load navigation data for all of time and space?!)_. To pass the time, they introduce you to their favorite [marble](https://en.wikipedia.org/wiki/Marble_(toy)) game.
