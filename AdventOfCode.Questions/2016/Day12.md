...
You remotely connect to the monorail control systems and discover that the boot sequence expects a password. The password-checking logic (your puzzle input) is easy to extract, but the code it uses is strange: it's assembunny _(Strangely, this assembunny code doesn't seem to be very good at multiplying.)_ code designed for the [new computer](Day11.md) you just assembled. You'll have to execute the code and get the password.
