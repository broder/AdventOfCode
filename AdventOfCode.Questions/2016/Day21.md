...
The computer system you're breaking into uses a weird scrambling function _(I do not like them, Security-Account-Manager-I-Am! I do not like scrambled letters and hash!)_ to store its passwords. It shouldn't be much trouble to create your own scrambled password so you can add it to the system; you just have to implement the scrambler.
