...
While BOOST (your puzzle input) is capable of boosting your sensors, for tenuous safety reasons _(Oh sure, NOW safety is a priority.)_, it refuses to do so until the computer it runs on passes some checks to demonstrate it is a _complete Intcode computer_.

[Your existing Intcode computer](Day05.md) is missing one key feature: it needs support for parameters in _relative mode_.
