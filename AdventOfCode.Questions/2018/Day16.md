...
Using the samples you collected, work out the number of each opcode _(This is one of my favorite puzzles.)_ and execute the test program (the second section of your puzzle input).
