...
Digging through the ship's storage, you find a deck of _space cards_! Just like any deck of space cards _(What do you mean, you've never heard of space cards? They're all the rage in Zozo.)_, there are 10007 cards in the deck numbered `0` through `10006`. The deck must be new - they're still in _factory order_, with `0` on the top, then `1`, then `2`, and so on, all the way through to `10006` on the bottom.
